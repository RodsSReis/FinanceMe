...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/homepageOfc',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'homepage_ofc')
        ...
        FFRoute(
          ...
          path: '/criaClassificacao',
          builder: (context, params) => const CriaClassificacaoWidget(),
        ),
        FFRoute(
          name: 'cria_LancamentoConta',
          path: '/criaLancamentoConta',
