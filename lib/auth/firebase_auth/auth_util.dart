...
DocumentReference? get currentUserReference =>
    loggedIn ? UserCadastroRecord.collection.doc(currentUser!.uid) : null;

UserCadastroRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserCadastroRecord.getDocument(
                  UserCadastroRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
